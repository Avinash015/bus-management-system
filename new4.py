...
connector.execute(
"CREATE TABLE IF NOT EXISTS BUS_MANAGEMENT (SERVICE_NO TEXT PRIMARY KEY AUTOINCREMENT NOT NULL, SOURCE TEXT, DESTINATION TEXT, TYPE_OF_BUS TEXT,  FARE INTEGER)"
)
